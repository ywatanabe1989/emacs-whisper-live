...
(defvar whisper-live-voice-commands
  '(("speech completed" . whisper-live-stop-and-send)
    ...
    ("speech is completed" . whisper-live-stop-and-send)
    ("my speech is completed" . whisper-live-stop-and-send)
    ("stop speech" . whisper-live-stop-and-send)
    ("speech stop" . whisper-live-stop-and-send)
    ("speech end" . whisper-live-stop)
    ("end speech" . whisper-live-stop)
    ("speech switch" . whisper-live-cycle-language)
    ("speech cancel" . whisper-live-cancel)
    ("speech clear" . whisper-live-cancel)
    ("cancel speech" . whisper-live-cancel))
